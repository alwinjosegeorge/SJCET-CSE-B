...
import { C as Bell, c as Settings, h as House, x as CalendarDays } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell-BTcutmU8.js
...
function AppShell({ header, children }) {
	...
	(0, import_react.useEffect)(() => {
		if ((localStorage.getItem("sjcet_theme") || "light") === "dark") document.documentElement.classList.add("dark");

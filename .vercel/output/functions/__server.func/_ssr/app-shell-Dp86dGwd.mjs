...
import { p as House, s as Settings, x as Bell, y as CalendarDays } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell-Dp86dGwd.js
...
function AppShell({ header, children }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const handler = () => {
			if (localStorage.getItem("sjcet_theme") === "system") apply("system");
		};
